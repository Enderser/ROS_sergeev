...
def generate_launch_description():
    # Setup project paths
    pkg_project_bringup = get_package_share_directory('diff_drive_bringup')
    pkg_project_description = get_package_share_directory('diff_drive_description')
